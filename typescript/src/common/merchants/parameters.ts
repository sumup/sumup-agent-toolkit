              ...
              street_address: z
                .array(
                  z
                    .string()
                    .max(100)
                    .describe(`The first line of the address.`),
                )
                .max(2)
                .optional(),
              post_code: z
...
`,
        ...
        .describe(`Base schema for a person associated with a merchant. This can be a legal representative, business owner (ultimate beneficial owner), or an officer. A legal representative is the person who registered the merchant with SumUp. They should always have a \`user_id\`.
`),
    ),
  })
