...
export const getPaymentMethodsParameters = {
...
export const createCheckoutParameters = {
...
export const listCheckoutsParameters = {
  checkout_reference: z
    .string()
    .describe(
...
export const getCheckoutParameters = {
  id: z.string().describe(`Unique ID of the checkout resource.`),
};

export const processCheckoutParameters = {
  payment_type: z
  ...
  card: z
    .object({
      name: z
        .string()
        .describe(`Name of the cardholder as it appears on the payment card.`),
      number: z
        .string()
...
export const deactivateCheckoutParameters = {
  id: z.string().describe(`Unique ID of the checkout resource.`),
};
